...
function Header() {
    ...
    //         e.preventDefault()
    //         getFilms(e.target.searchFilm.value)
    ...
    const handleSearchFilm = (e) => {
        ...
        // const valueF=(e.target.searchFilm.value)
        setFilmsValue(...filmsValue,e.target.searchFilm.value)    
        console.log(filmsValue)
    }
    // console.log(e.target.searchFilm.value)

    // const handleCloseSession = () => {
    //     localStorage.setItem('value',e.target.searchFilm.value )
